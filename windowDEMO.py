...
class PaintBoard(QWidget):
    ...
    def __InitData(self):
        ...
        self.__board.fill(Qt.black)  # 用balck色填充画板
...
class MainWidget(QWidget):
    ...
    def __InitView(self):
        ...
        # 将按键按下信号与画板清空函数相关联
        self.__btn_Clear.clicked.connect(self.__self_clear)
        ...
        self.__btn_Save = QPushButton("进行识别")
        self.__btn_Save.setParent(self)
        self.__btn_Save.clicked.connect(self.on_btn_Save_Clicked)
        sub_layout.addWidget(self.__btn_Save)

        self.__textBox = QLineEdit(self)
        self.__textBox.setParent(self)
    ...
    def on_btn_Save_Clicked(self):
        ...
        temp_path = "./temp_image_file.png"
        image = self.__paintBoard.GetContentAsQImage()
        image.save(temp_path)

        img = cv2.imread("./temp_image_file.png")
        ...
        self.__textBox.setText(str((np.argmax(result_array,1)[0])))
